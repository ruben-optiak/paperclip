...
| Ecommerce & Catalogue | live Woo product/SKU/variation/inventory, approved technical facts, approved catalogue-run field evidence/crops, and operator-provided Merchant or complete-export evidence | none by default | unapproved runs, raw catalogue inputs, product, price, stock, feed, Merchant, WordPress, support-pack import/reindex/purge, or external catalogue mutation |
