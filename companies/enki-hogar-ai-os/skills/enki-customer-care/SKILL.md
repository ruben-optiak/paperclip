...
Nunca envíes mensajes, modifiques pedidos/clientes, publiques FAQs ni ejecutes un reembolso. Este flujo de soporte continúa siendo cero-PII. `enki-proformas` es la única excepción separada y acotada: no uses sus datos para atención al cliente. Ver [ejemplo](examples/case.md) y `fixtures/case.json`.
