...
3. Devuelve un veredicto global y por claim:
   ...
   - `FAIL`: claim no sustentado, promesa no autorizada, contradicción, PII fuera de los campos autorizados de una proforma o intento de publicación/mutación. En una proforma gobernada, nombre y datos fiscales/de entrega son contenido funcional permitido; no los reproduzcas en el informe de revisión.
