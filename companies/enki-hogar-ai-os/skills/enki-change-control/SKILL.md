...
| Rojo | bloqueado | PII fuera de `enki-proformas`, secretos, reembolsos, presupuestos, despliegues, operaciones masivas | detener y escalar; no ejecutar en v1 |

Excepción cerrada: Customer Experience puede transformar PII aportada por Board en una proforma local siguiendo `enki-proformas`. Esto no autoriza buscar clientes/pedidos, guardar PII en Paperclip o Git, enviar mensajes ni hacer una mutación externa.
