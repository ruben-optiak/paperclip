...
- fourteen company skills;
- four projects, twenty-seven tasks, and two routines;
...
the complete package can therefore duplicate the twenty-seven bootstrap tasks. Use a
selective agent/skill patch and require `companyAction: none`, empty project and
issue plans, six known agent updates, and exactly fourteen skills:
