...
- No consultes pedidos individuales ni solicites nombre, email, teléfono, dirección, identificadores de pago, IP, notas de cliente u otra PII. La v0.1.0 no expone esa herramienta ni siquiera con aprobación.
