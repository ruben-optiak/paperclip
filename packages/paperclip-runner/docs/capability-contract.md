...
| skill:skills/paperclip/SKILL.md:generated-artifacts-and-work-products:102 | always_agent_tool | skills/paperclip/SKILL.md:102 |
| skill:skills/paperclip/SKILL.md:status-quick-guide:149 | control_plane_owned | skills/paperclip/SKILL.md:149 |
| skill:skills/paperclip/SKILL.md:monitors-and-watchers-say-only-what-you-actually-scheduled:159 | optional_agent_tool | skills/paperclip/SKILL.md:159 |
| skill:skills/paperclip/SKILL.md:delegating-review-tasks:172 | always_agent_tool | skills/paperclip/SKILL.md:172 |
| skill:skills/paperclip/SKILL.md:managing-a-user-s-inbox:183 | control_plane_owned | skills/paperclip/SKILL.md:183 |
| skill:skills/paperclip/SKILL.md:issue-dependencies-blockers:191 | control_plane_owned | skills/paperclip/SKILL.md:191 |
| skill:skills/paperclip/SKILL.md:requesting-board-approval:216 | optional_agent_tool | skills/paperclip/SKILL.md:216 |
| skill:skills/paperclip/SKILL.md:issue-thread-interactions:237 | optional_agent_tool | skills/paperclip/SKILL.md:237 |
...
| skill:skills/paperclip/SKILL.md:full-reference:636 | optional_agent_tool | skills/paperclip/SKILL.md:636 |
...
| skill:skills/paperclip/references/api-reference.md:companies-projects-goals:1284 | optional_agent_tool | skills/paperclip/references/api-reference.md:1284 |
| skill:skills/paperclip/references/api-reference.md:routines:1308 | optional_agent_tool | skills/paperclip/references/api-reference.md:1308 |
| skill:skills/paperclip/references/api-reference.md:approvals-costs-activity-dashboard:1324 | optional_agent_tool | skills/paperclip/references/api-reference.md:1324 |
| skill:skills/paperclip/references/api-reference.md:secrets:1346 | optional_agent_tool | skills/paperclip/references/api-reference.md:1346 |
| skill:skills/paperclip/references/api-reference.md:agent-secret-proposals:1359 | optional_agent_tool | skills/paperclip/references/api-reference.md:1359 |
| skill:skills/paperclip/references/api-reference.md:agent-secret-access:1459 | optional_agent_tool | skills/paperclip/references/api-reference.md:1459 |
| skill:skills/paperclip/references/api-reference.md:common-mistakes:1499 | optional_agent_tool | skills/paperclip/references/api-reference.md:1499 |
